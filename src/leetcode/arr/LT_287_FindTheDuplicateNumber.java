 ...
 */
public class LT_287_FindTheDuplicateNumber {
    // 根据要求的解法，就是sort, 然后找到i == i+1 的num，返回，不写了

    //优化的才是关键，怎么做到O(n), O(1), 循环遍历
    /*
    First off, we can easily show that the constraints of the problem imply that a cycle must exist.
     ...
     Additionally, because 00 cannot appear as a value in nums, nums[0] cannot be part of the cycle.
