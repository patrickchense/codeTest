...
两种方式，要解决get的时候查找的问题，1. treemap 2. binarysearch
treemap 用 tree.floorKey(timestamp);


 */
public class LT981_Time_Based_KV_Store {
    Map<String, List<Pair<Integer, String>>> M = new HashMap();;
