...
solution:
Simple Solution is to use sorting. First sort the input array, then swap all adjacent elements.
O(nlogn)
...
solution2: O(n)
raverse all even positioned elements of input array, and do following.
