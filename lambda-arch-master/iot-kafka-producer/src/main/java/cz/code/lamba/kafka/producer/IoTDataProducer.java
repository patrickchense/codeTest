package cz.code.lamba.kafka.producer;
...
import cz.code.lamba.kafka.util.PropertyFileReader;
import cz.code.lamba.kafka.vo.IoTData;
...
public class IoTDataProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		String zookeeper = prop.getProperty("cz.code.lamba.kafka.zookeeper");
		String brokerList = prop.getProperty("cz.code.lamba.kafka.brokerlist");
		String topic = prop.getProperty("cz.code.lamba.kafka.topic");
		...
		properties.put("serializer.class", "cz.code.lamba.kafka.util.IoTDataEncoder");
		//generate event
