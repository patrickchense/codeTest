...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "code.chenzhe.exp.springrpc.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<code.chenzhe.exp.springrpc.Person,
      code.chenzhe.exp.springrpc.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = code.chenzhe.exp.springrpc.Person.class,
      responseType = code.chenzhe.exp.springrpc.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<code.chenzhe.exp.springrpc.Person,
      code.chenzhe.exp.springrpc.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<code.chenzhe.exp.springrpc.Person, code.chenzhe.exp.springrpc.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<code.chenzhe.exp.springrpc.Person, code.chenzhe.exp.springrpc.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "code.chenzhe.exp.springrpc.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  code.chenzhe.exp.springrpc.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  code.chenzhe.exp.springrpc.Greeting.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(code.chenzhe.exp.springrpc.Person request,
        io.grpc.stub.StreamObserver<code.chenzhe.exp.springrpc.Greeting> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                code.chenzhe.exp.springrpc.Person,
                code.chenzhe.exp.springrpc.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public code.chenzhe.exp.springrpc.Greeting sayHello(code.chenzhe.exp.springrpc.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<code.chenzhe.exp.springrpc.Greeting> sayHello(
        code.chenzhe.exp.springrpc.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((code.chenzhe.exp.springrpc.Person) request,
              (io.grpc.stub.StreamObserver<code.chenzhe.exp.springrpc.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return code.chenzhe.exp.springrpc.HelloWorld.getDescriptor();
    }
